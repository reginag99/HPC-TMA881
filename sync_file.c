...
=======
>>>>>>> ac922ade42dec9ba79fb347396e56a0b7ab19cf9
  double *wReal;
  double *wImg;
...
//Genererar axlarna i datamatrisen
  int i;
  double jx;
...
<<<<<<< HEAD
    thrd_sleep(&(struct timespec){.tv_sec=0, .tv_nsec=1000}, NULL); //VARFÖR VILL DU GÖRA DETTA? 
  }
  return 0;
}


//Kollar så allt stämmer
int
main_thrd_check(
    void *args
    )
...
//Huvudskriptet. Strukturerar upp hur trådarna ska användas
=======
>>>>>>> ac922ade42dec9ba79fb347396e56a0b7ab19cf9
int
main()
...
<<<<<<< HEAD
// tx 0 ib = 2, tx 1 ib = 2-1/stepSize ...    VARFÖR JUST DESSA STEG                                                                                                                        
=======
